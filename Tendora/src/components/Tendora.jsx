        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {todos.map((item) => (
            <div
              ...
              className={`rounded-2xl shadow-lg border p-4 transition relative cursor-pointer flex flex-col ${
                isDark
            ...
            >
              ...
              <button className="flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-semibold transition gap-2 mt-2">
                <FiShoppingCart />
                {t.buyNow[language]}
              </button>
            </div>
